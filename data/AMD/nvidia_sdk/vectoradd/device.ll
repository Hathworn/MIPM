...
define protected amdgpu_kernel void @_Z9vectorAddPKfS0_Pfi(float addrspace(1)* nocapture readonly %0, float addrspace(1)* nocapture readonly %1, float addrspace(1)* nocapture writeonly %2, i32 %3) local_unnamed_addr #0 {
...
15:                                               ; preds = %4
  ...
  %23 = getelementptr inbounds float, float addrspace(1)* %2, i64 %16
