...
define protected amdgpu_kernel void @_Z18fastWalshTransformPfi(float addrspace(1)* nocapture %0, i32 %1) local_unnamed_addr #0 {
  ...
  store float %27, float addrspace(1)* %22, align 4, !tbaa !7
