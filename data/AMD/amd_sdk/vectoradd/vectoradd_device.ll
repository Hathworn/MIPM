...
define protected amdgpu_kernel void @_Z15vectoradd_floatPfPKfS1_ii(float addrspace(1)* noalias nocapture writeonly %0, float addrspace(1)* noalias nocapture readonly %1, float addrspace(1)* noalias nocapture readonly %2, i32 %3, i32 %4) local_unnamed_addr #0 {
  ...
  %12 = mul i32 %7, %11
  %13 = tail call i32 @llvm.amdgcn.workitem.id.x() #2, !range !6
  %14 = add i32 %12, %13
  ...
  %20 = mul i32 %15, %19
  %21 = tail call i32 @llvm.amdgcn.workitem.id.y() #2, !range !6
  %22 = add i32 %20, %21
  %23 = mul nsw i32 %22, %3
...
28:                                               ; preds = %5
  ...
  %33 = load float, float addrspace(1)* %30, align 4, !tbaa !7
  %34 = fadd contract float %32, %33
  store float %34, float addrspace(1)* %29, align 4, !tbaa !7
  br label %35
