...
@.str.26 = private unnamed_addr constant [25 x i8] c"Cannot open output file\0A\00", align 1
@ck = internal global [1024 x %struct.kValues] undef, align 16
@_Z17ComputePhiMag_GPUPfS_S_i = dso_local constant void (float*, float*, float*, i32)* @_Z32__device_stub__ComputePhiMag_GPUPfS_S_i, align 8
@_Z12ComputeQ_GPUiiPfS_S_S_S_ = dso_local constant void (i32, i32, float*, float*, float*, float*, float*)* @_Z27__device_stub__ComputeQ_GPUiiPfS_S_S_S_, align 8
@.str.27 = private unnamed_addr constant [30 x i8] c"Expecting one input filename\0A\00", align 1
@.str.28 = private unnamed_addr constant [32 x i8] c"Expecting an integer parameter\0A\00", align 1
@.str.29 = private unnamed_addr constant [65 x i8] c"%d pixels in output; %d samples in trajectory; using %d samples\0A\00", align 1
@.str.30 = private unnamed_addr constant [27 x i8] c"CUDA error on line %d: %s\0A\00", align 1
...
@0 = private unnamed_addr constant [29 x i8] c"_Z17ComputePhiMag_GPUPfS_S_i\00", align 1
@1 = private unnamed_addr constant [29 x i8] c"_Z12ComputeQ_GPUiiPfS_S_S_S_\00", align 1
@2 = private unnamed_addr constant [3 x i8] c"ck\00", align 1
...
30:                                               ; preds = %28
  ...
  %32 = tail call i64 @fwrite(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.31, i64 0, i64 0), i64 16, i64 1, %struct._IO_FILE* %31) #23
...
45:                                               ; preds = %41
  ...
  %47 = tail call i64 @fwrite(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.31, i64 0, i64 0), i64 16, i64 1, %struct._IO_FILE* %46) #23
  br label %48
...
57:                                               ; preds = %54
  ...
  %59 = tail call i64 @fwrite(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.31, i64 0, i64 0), i64 16, i64 1, %struct._IO_FILE* %58) #23
  br label %60
...
110:                                              ; preds = %108
  ...
  %112 = tail call i64 @fwrite(i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.32, i64 0, i64 0), i64 14, i64 1, %struct._IO_FILE* %111) #23
...
; Function Attrs: mustprogress nounwind uwtable
define dso_local void @inputData(i8* nocapture readonly %0, i32* nocapture writeonly %1, i32* nocapture writeonly %2, float** nocapture writeonly %3, float** nocapture writeonly %4, float** nocapture writeonly %5, float** nocapture writeonly %6, float** nocapture writeonly %7, float** nocapture writeonly %8, float** nocapture writeonly %9, float** nocapture writeonly %10) local_unnamed_addr #0 {
  ...
  %16 = tail call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.23, i64 0, i64 0))
  %17 = icmp eq %struct._IO_FILE* %16, null
  br i1 %17, label %18, label %21

18:                                               ; preds = %11
  %19 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %20 = tail call i64 @fwrite(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.24, i64 0, i64 0), i64 23, i64 1, %struct._IO_FILE* %19) #24
  tail call void @exit(i32 -1) #26
  unreachable

21:                                               ; preds = %11
  %22 = call i64 @fread(i8* nonnull %14, i64 4, i64 1, %struct._IO_FILE* nonnull %16)
  %23 = load i32, i32* %12, align 4, !tbaa !10
  store i32 %23, i32* %1, align 4, !tbaa !10
  %24 = call i64 @fread(i8* nonnull %15, i64 4, i64 1, %struct._IO_FILE* nonnull %16)
  %25 = load i32, i32* %13, align 4, !tbaa !10
  store i32 %25, i32* %2, align 4, !tbaa !10
  %26 = sext i32 %23 to i64
  %27 = shl nsw i64 %26, 2
  %28 = tail call noalias align 16 i8* @memalign(i64 16, i64 %27) #22
  %29 = bitcast float** %3 to i8**
  store i8* %28, i8** %29, align 8, !tbaa !9
  %30 = tail call i64 @fread(i8* %28, i64 4, i64 %26, %struct._IO_FILE* nonnull %16)
  %31 = tail call noalias align 16 i8* @memalign(i64 16, i64 %27) #22
  %32 = bitcast float** %4 to i8**
  store i8* %31, i8** %32, align 8, !tbaa !9
  %33 = tail call i64 @fread(i8* %31, i64 4, i64 %26, %struct._IO_FILE* nonnull %16)
  %34 = tail call noalias align 16 i8* @memalign(i64 16, i64 %27) #22
  %35 = bitcast float** %5 to i8**
  store i8* %34, i8** %35, align 8, !tbaa !9
  %36 = tail call i64 @fread(i8* %34, i64 4, i64 %26, %struct._IO_FILE* nonnull %16)
  %37 = sext i32 %25 to i64
  %38 = shl nsw i64 %37, 2
  %39 = tail call noalias align 16 i8* @memalign(i64 16, i64 %38) #22
  %40 = bitcast float** %6 to i8**
  store i8* %39, i8** %40, align 8, !tbaa !9
  %41 = tail call i64 @fread(i8* %39, i64 4, i64 %37, %struct._IO_FILE* nonnull %16)
  %42 = tail call noalias align 16 i8* @memalign(i64 16, i64 %38) #22
  %43 = bitcast float** %7 to i8**
  store i8* %42, i8** %43, align 8, !tbaa !9
  %44 = tail call i64 @fread(i8* %42, i64 4, i64 %37, %struct._IO_FILE* nonnull %16)
  %45 = tail call noalias align 16 i8* @memalign(i64 16, i64 %38) #22
  %46 = bitcast float** %8 to i8**
  store i8* %45, i8** %46, align 8, !tbaa !9
  %47 = tail call i64 @fread(i8* %45, i64 4, i64 %37, %struct._IO_FILE* nonnull %16)
  %48 = tail call noalias align 16 i8* @memalign(i64 16, i64 %27) #22
  %49 = bitcast float** %9 to i8**
  store i8* %48, i8** %49, align 8, !tbaa !9
  %50 = tail call i64 @fread(i8* %48, i64 4, i64 %26, %struct._IO_FILE* nonnull %16)
  %51 = tail call noalias align 16 i8* @memalign(i64 16, i64 %27) #22
  %52 = bitcast float** %10 to i8**
  store i8* %51, i8** %52, align 8, !tbaa !9
  %53 = tail call i64 @fread(i8* %51, i64 4, i64 %26, %struct._IO_FILE* nonnull %16)
  %54 = tail call i32 @fclose(%struct._IO_FILE* nonnull %16)
...
; Function Attrs: inaccessiblememonly mustprogress nofree nounwind willreturn
declare dso_local noalias noundef i8* @memalign(i64, i64) local_unnamed_addr #2

; Function Attrs: nofree nounwind
declare dso_local noundef i32 @fclose(%struct._IO_FILE* nocapture noundef) local_unnamed_addr #5

; Function Attrs: mustprogress nounwind uwtable
define dso_local void @outputData(i8* nocapture readonly %0, float* nocapture %1, float* nocapture %2, i32 %3) local_unnamed_addr #0 {
  %5 = alloca i32, align 4
  %6 = tail call %struct._IO_FILE* @fopen(i8* %0, i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.25, i64 0, i64 0))
...
9:                                                ; preds = %4
  ...
  %11 = tail call i64 @fwrite(i8* getelementptr inbounds ([25 x i8], [25 x i8]* @.str.26, i64 0, i64 0), i64 24, i64 1, %struct._IO_FILE* %10) #24
  tail call void @exit(i32 -1) #26
  unreachable

12:                                               ; preds = %4
  store i32 %3, i32* %5, align 4, !tbaa !10
  %13 = call i64 @fwrite(i8* nonnull %7, i64 4, i64 1, %struct._IO_FILE* nonnull %6)
  %14 = bitcast float* %1 to i8*
  %15 = sext i32 %3 to i64
  %16 = tail call i64 @fwrite(i8* %14, i64 4, i64 %15, %struct._IO_FILE* nonnull %6)
  %17 = bitcast float* %2 to i8*
  %18 = tail call i64 @fwrite(i8* %17, i64 4, i64 %15, %struct._IO_FILE* nonnull %6)
...
define dso_local void @_Z32__device_stub__ComputePhiMag_GPUPfS_S_i(float* %0, float* %1, float* %2, i32 %3) #15 {
  ...
  store float* %0, float** %5, align 8, !tbaa !9
  ...
  %34 = call i32 @hipLaunchKernel(i8* bitcast (void (float*, float*, float*, i32)** @_Z17ComputePhiMag_GPUPfS_S_i to i8*), i64 %27, i32 %29, i64 %31, i32 %33, i8** nonnull %14, i64 %23, %struct.ihipStream_t* %25)
  ret void
}
...
; Function Attrs: norecurse uwtable
define dso_local void @_Z27__device_stub__ComputeQ_GPUiiPfS_S_S_S_(i32 %0, i32 %1, float* %2, float* %3, float* %4, float* %5, float* %6) #15 {
  %8 = alloca i32, align 4
  ...
  store float* %2, float** %10, align 8, !tbaa !9
  store float* %3, float** %11, align 8, !tbaa !9
  store float* %4, float** %12, align 8, !tbaa !9
  store float* %5, float** %13, align 8, !tbaa !9
  ...
  store float** %13, float*** %31, align 8
  ...
  %46 = call i32 @hipLaunchKernel(i8* bitcast (void (i32, i32, float*, float*, float*, float*, float*)** @_Z12ComputeQ_GPUiiPfS_S_S_S_ to i8*), i64 %39, i32 %41, i64 %43, i32 %45, i8** nonnull %20, i64 %35, %struct.ihipStream_t* %37)
  ret void
}

; Function Attrs: uwtable
define dso_local void @_Z17computePhiMag_GPUiPfS_S_(i32 %0, float* %1, float* %2, float* %3) local_unnamed_addr #17 {
  %5 = alloca float*, align 8
  %6 = alloca float*, align 8
  %7 = alloca float*, align 8
  %8 = alloca i32, align 4
  ...
  %21 = tail call i32 @__hipPushCallConfiguration(i64 %20, i32 1, i64 4294967808, i32 1, i64 0, %struct.ihipStream_t* null)
  %22 = icmp eq i32 %21, 0
...
23:                                               ; preds = %4
  ...
  %29 = bitcast %struct.dim3* %10 to i8*
  ...
  %32 = bitcast [4 x i8*]* %13 to i8*
  call void @llvm.lifetime.start.p0i8(i64 32, i8* nonnull %32)
  store float* %1, float** %5, align 8, !tbaa !9
  store float* %2, float** %6, align 8, !tbaa !9
  store float* %3, float** %7, align 8, !tbaa !9
  store i32 %0, i32* %8, align 4, !tbaa !10
  %33 = getelementptr inbounds [4 x i8*], [4 x i8*]* %13, i64 0, i64 0
  %34 = bitcast [4 x i8*]* %13 to float***
  store float** %5, float*** %34, align 16
  %35 = getelementptr inbounds [4 x i8*], [4 x i8*]* %13, i64 0, i64 1
  %36 = bitcast i8** %35 to float***
  store float** %6, float*** %36, align 8
  %37 = getelementptr inbounds [4 x i8*], [4 x i8*]* %13, i64 0, i64 2
  %38 = bitcast i8** %37 to float***
  store float** %7, float*** %38, align 16
  %39 = getelementptr inbounds [4 x i8*], [4 x i8*]* %13, i64 0, i64 3
  %40 = bitcast i8** %39 to i32**
  store i32* %8, i32** %40, align 8
  %41 = call i32 @__hipPopCallConfiguration(%struct.dim3* nonnull %9, %struct.dim3* nonnull %10, i64* nonnull %11, i8** nonnull %12)
  %42 = load i64, i64* %11, align 8
  %43 = bitcast i8** %12 to %struct.ihipStream_t**
  %44 = load %struct.ihipStream_t*, %struct.ihipStream_t** %43, align 8
  %45 = bitcast %struct.dim3* %9 to i64*
  %46 = load i64, i64* %45, align 8
  %47 = getelementptr inbounds %struct.dim3, %struct.dim3* %9, i64 0, i32 2
  %48 = load i32, i32* %47, align 8
  %49 = bitcast %struct.dim3* %10 to i64*
  %50 = load i64, i64* %49, align 8
  %51 = getelementptr inbounds %struct.dim3, %struct.dim3* %10, i64 0, i32 2
  %52 = load i32, i32* %51, align 8
  %53 = call i32 @hipLaunchKernel(i8* bitcast (void (float*, float*, float*, i32)** @_Z17ComputePhiMag_GPUPfS_S_i to i8*), i64 %46, i32 %48, i64 %50, i32 %52, i8** nonnull %33, i64 %42, %struct.ihipStream_t* %44)
...
; Function Attrs: uwtable
define dso_local void @_Z12computeQ_GPUiiPfS_S_P7kValuesS_S_(i32 %0, i32 %1, float* %2, float* %3, float* %4, %struct.kValues* %5, float* %6, float* %7) local_unnamed_addr #17 {
  %9 = alloca i32, align 4
  ...
  %35 = bitcast float** %11 to i8*
  %36 = bitcast float** %12 to i8*
  %37 = bitcast float** %13 to i8*
  %38 = bitcast float** %14 to i8*
  %39 = bitcast float** %15 to i8*
  %40 = bitcast %struct.dim3* %16 to i8*
  %41 = bitcast %struct.dim3* %17 to i8*
  %42 = bitcast i64* %18 to i8*
  %43 = bitcast i8** %19 to i8*
  %44 = bitcast [7 x i8*]* %20 to i8*
  %45 = getelementptr inbounds [7 x i8*], [7 x i8*]* %20, i64 0, i64 0
  %46 = bitcast [7 x i8*]* %20 to i32**
  %47 = getelementptr inbounds [7 x i8*], [7 x i8*]* %20, i64 0, i64 1
  %48 = bitcast i8** %47 to i32**
  %49 = getelementptr inbounds [7 x i8*], [7 x i8*]* %20, i64 0, i64 2
  %50 = bitcast i8** %49 to float***
  %51 = getelementptr inbounds [7 x i8*], [7 x i8*]* %20, i64 0, i64 3
  %52 = bitcast i8** %51 to float***
  %53 = getelementptr inbounds [7 x i8*], [7 x i8*]* %20, i64 0, i64 4
  %54 = bitcast i8** %53 to float***
  %55 = getelementptr inbounds [7 x i8*], [7 x i8*]* %20, i64 0, i64 5
  %56 = bitcast i8** %55 to float***
  %57 = getelementptr inbounds [7 x i8*], [7 x i8*]* %20, i64 0, i64 6
  %58 = bitcast i8** %57 to float***
  %59 = bitcast i8** %19 to %struct.ihipStream_t**
  %60 = bitcast %struct.dim3* %16 to i64*
  %61 = getelementptr inbounds %struct.dim3, %struct.dim3* %16, i64 0, i32 2
  %62 = bitcast %struct.dim3* %17 to i64*
  %63 = getelementptr inbounds %struct.dim3, %struct.dim3* %17, i64 0, i32 2
...
69:                                               ; preds = %65, %92
  %70 = phi i64 [ 0, %65 ], [ %93, %92 ]
  %71 = shl nsw i64 %70, 10
  %72 = getelementptr inbounds %struct.kValues, %struct.kValues* %5, i64 %71
  %73 = sub nsw i64 %66, %71
  %74 = icmp slt i64 %73, 1024
  %75 = select i1 %74, i64 %73, i64 1024
  %76 = bitcast %struct.kValues* %72 to i8*
  %77 = shl i64 %75, 32
  %78 = ashr exact i64 %77, 28
  %79 = call i32 @hipMemcpyToSymbol(i8* nonnull bitcast ([1024 x %struct.kValues]* @ck to i8*), i8* %76, i64 %78, i64 0, i32 1)
  %80 = call i32 @__hipPushCallConfiguration(i64 %32, i32 1, i64 4294967552, i32 1, i64 0, %struct.ihipStream_t* null)
  %81 = icmp eq i32 %80, 0
...
82:                                               ; preds = %69
  ...
  call void @llvm.lifetime.start.p0i8(i64 56, i8* nonnull %44)
  store i32 %0, i32* %9, align 4, !tbaa !10
  %83 = trunc i64 %71 to i32
  store i32 %83, i32* %10, align 4, !tbaa !10
  store float* %2, float** %11, align 8, !tbaa !9
  store float* %3, float** %12, align 8, !tbaa !9
  store float* %4, float** %13, align 8, !tbaa !9
  store float* %6, float** %14, align 8, !tbaa !9
  store float* %7, float** %15, align 8, !tbaa !9
  store i32* %9, i32** %46, align 16
  store i32* %10, i32** %48, align 8
  store float** %11, float*** %50, align 16
  store float** %12, float*** %52, align 8
  store float** %13, float*** %54, align 16
  store float** %14, float*** %56, align 8
  store float** %15, float*** %58, align 16
  %84 = call i32 @__hipPopCallConfiguration(%struct.dim3* nonnull %16, %struct.dim3* nonnull %17, i64* nonnull %18, i8** nonnull %19)
  %85 = load i64, i64* %18, align 8
  %86 = load %struct.ihipStream_t*, %struct.ihipStream_t** %59, align 8
  %87 = load i64, i64* %60, align 8
  %88 = load i32, i32* %61, align 8
  %89 = load i64, i64* %62, align 8
  %90 = load i32, i32* %63, align 8
  %91 = call i32 @hipLaunchKernel(i8* bitcast (void (i32, i32, float*, float*, float*, float*, float*)** @_Z12ComputeQ_GPUiiPfS_S_S_S_ to i8*), i64 %87, i32 %88, i64 %89, i32 %90, i8** nonnull %45, i64 %85, %struct.ihipStream_t* %86)
  ...
  call void @llvm.lifetime.end.p0i8(i64 56, i8* nonnull %44)
  br label %92

92:                                               ; preds = %82, %69
  %93 = add nuw nsw i64 %70, 1
  %94 = icmp eq i64 %93, %67
  br i1 %94, label %68, label %69, !llvm.loop !73
}

; Function Attrs: mustprogress nofree nounwind uwtable willreturn
define dso_local void @_Z20createDataStructsCPUiiPPfS0_S0_(i32 %0, i32 %1, float** nocapture writeonly %2, float** nocapture writeonly %3, float** nocapture writeonly %4) local_unnamed_addr #18 {
  %6 = sext i32 %0 to i64
  %7 = shl nsw i64 %6, 2
  %8 = tail call noalias align 16 i8* @memalign(i64 16, i64 %7) #22
  %9 = bitcast float** %2 to i8**
  store i8* %8, i8** %9, align 8, !tbaa !9
  %10 = sext i32 %1 to i64
  %11 = shl nsw i64 %10, 2
  %12 = tail call noalias align 16 i8* @memalign(i64 16, i64 %11) #22
  %13 = bitcast float** %3 to i8**
  store i8* %12, i8** %13, align 8, !tbaa !9
  %14 = tail call noalias align 16 i8* @memalign(i64 16, i64 %11) #22
...
define dso_local i32 @main(i32 %0, i8** %1) local_unnamed_addr #19 {
  %3 = alloca %struct.timeval, align 8
  ...
  %13 = alloca float*, align 8
  %14 = alloca float*, align 8
  %15 = alloca %struct.pb_TimerSet, align 8
  ...
  %35 = bitcast %struct.pb_TimerSet* %15 to i8*
  call void @llvm.lifetime.start.p0i8(i64 288, i8* nonnull %35) #22
  %36 = bitcast %struct.timeval* %3 to i8*
  call void @llvm.lifetime.start.p0i8(i64 16, i8* nonnull %36) #22
  %37 = call i32 @gettimeofday(%struct.timeval* nonnull %3, %struct.timezone* null) #22
  %38 = getelementptr inbounds %struct.timeval, %struct.timeval* %3, i64 0, i32 0
  %39 = load i64, i64* %38, align 8, !tbaa !35
  %40 = mul nsw i64 %39, 1000000
  %41 = getelementptr inbounds %struct.timeval, %struct.timeval* %3, i64 0, i32 1
  %42 = load i64, i64* %41, align 8, !tbaa !38
  %43 = add nsw i64 %40, %42
  call void @llvm.lifetime.end.p0i8(i64 16, i8* nonnull %36) #22
  %44 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 3
  store i64 %43, i64* %44, align 8, !tbaa !41
  %45 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 0
  store i32 0, i32* %45, align 8, !tbaa !44
  %46 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 1
  store %struct.pb_async_time_marker_list* null, %struct.pb_async_time_marker_list** %46, align 8, !tbaa !45
  %47 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 0, i32 0
  store i32 0, i32* %47, align 8, !tbaa !30
  %48 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 0, i32 1
  store i64 0, i64* %48, align 8, !tbaa !34
  %49 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 5, i64 0
  %50 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 1, i32 0
  store i32 0, i32* %50, align 8, !tbaa !30
  %51 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 1, i32 1
  store i64 0, i64* %51, align 8, !tbaa !34
  %52 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 2, i32 0
  store i32 0, i32* %52, align 8, !tbaa !30
  %53 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 2, i32 1
  store i64 0, i64* %53, align 8, !tbaa !34
  %54 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 3, i32 0
  store i32 0, i32* %54, align 8, !tbaa !30
  %55 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 3, i32 1
  store i64 0, i64* %55, align 8, !tbaa !34
  %56 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 4, i32 0
  store i32 0, i32* %56, align 8, !tbaa !30
  %57 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 4, i32 1
  store i64 0, i64* %57, align 8, !tbaa !34
  %58 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 5, i32 0
  store i32 0, i32* %58, align 8, !tbaa !30
  %59 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 5, i32 1
  store i64 0, i64* %59, align 8, !tbaa !34
  %60 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 6, i32 0
  store i32 0, i32* %60, align 8, !tbaa !30
  %61 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 6, i32 1
  store i64 0, i64* %61, align 8, !tbaa !34
  %62 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 7, i32 0
  store i32 0, i32* %62, align 8, !tbaa !30
  %63 = getelementptr inbounds %struct.pb_TimerSet, %struct.pb_TimerSet* %15, i64 0, i32 4, i64 7, i32 1
  store i64 0, i64* %63, align 8, !tbaa !34
  %64 = bitcast %struct.pb_SubTimerList** %49 to i8*
  call void @llvm.memset.p0i8.i64(i8* noundef nonnull align 8 dereferenceable(64) %64, i8 0, i64 64, i1 false) #22
  %65 = call %struct.pb_Parameters* @pb_ReadParameters(i32* nonnull %4, i8** %1)
  %66 = getelementptr inbounds %struct.pb_Parameters, %struct.pb_Parameters* %65, i64 0, i32 1
  %67 = load i8**, i8*** %66, align 8, !tbaa !8
  %68 = load i8*, i8** %67, align 8, !tbaa !9
...
74:                                               ; preds = %70, %2
  %75 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %76 = tail call i64 @fwrite(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.27, i64 0, i64 0), i64 29, i64 1, %struct._IO_FILE* %75) #24
  tail call void @exit(i32 -1) #26
  unreachable

77:                                               ; preds = %70
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 1)
  %78 = load i8*, i8** %67, align 8, !tbaa !9
  call void @inputData(i8* %78, i32* nonnull %6, i32* nonnull %5, float** nonnull %7, float** nonnull %8, float** nonnull %9, float** nonnull %10, float** nonnull %11, float** nonnull %12, float** nonnull %13, float** nonnull %14)
  %79 = load i32, i32* %4, align 4, !tbaa !10
  %80 = icmp slt i32 %79, 2
  br i1 %80, label %81, label %83

81:                                               ; preds = %77
  %82 = load i32, i32* %6, align 4, !tbaa !10
  br label %99

83:                                               ; preds = %77
  %84 = bitcast i8** %16 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %84) #22
  %85 = getelementptr inbounds i8*, i8** %1, i64 1
  %86 = load i8*, i8** %85, align 8, !tbaa !9
  %87 = call i64 @strtol(i8* %86, i8** nonnull %16, i32 10) #22
  %88 = trunc i64 %87 to i32
  %89 = load i8*, i8** %16, align 8, !tbaa !9
  %90 = load i8*, i8** %85, align 8, !tbaa !9
  %91 = icmp eq i8* %89, %90
  br i1 %91, label %92, label %95

92:                                               ; preds = %83
  %93 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %94 = tail call i64 @fwrite(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.28, i64 0, i64 0), i64 31, i64 1, %struct._IO_FILE* %93) #24
  tail call void @exit(i32 -1) #26
  unreachable
...
95:                                               ; preds = %83
  ...
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %84) #22
  br label %99

99:                                               ; preds = %95, %81
  %100 = phi i32 [ %82, %81 ], [ %96, %95 ]
  %101 = phi i32 [ %82, %81 ], [ %98, %95 ]
  %102 = load i32, i32* %5, align 4, !tbaa !10
  %103 = tail call i32 (i8*, ...) @printf(i8* nonnull dereferenceable(1) getelementptr inbounds ([65 x i8], [65 x i8]* @.str.29, i64 0, i64 0), i32 %102, i32 %100, i32 %101)
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 6)
  %104 = sext i32 %101 to i64
  %105 = shl nsw i64 %104, 2
  %106 = tail call noalias align 16 i8* @memalign(i64 16, i64 %105) #22
  %107 = bitcast i8* %106 to float*
  %108 = sext i32 %102 to i64
  %109 = shl nsw i64 %108, 2
  %110 = tail call noalias align 16 i8* @memalign(i64 16, i64 %109) #22
  %111 = bitcast i8* %110 to float*
  %112 = tail call noalias align 16 i8* @memalign(i64 16, i64 %109) #22
  %113 = bitcast i8* %112 to float*
  %114 = bitcast float** %17 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %114) #22
  %115 = bitcast float** %18 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %115) #22
  %116 = bitcast float** %19 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %116) #22
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 3)
  call fastcc void @_ZL14setupMemoryGPUiiRPfS0_(i32 %101, float** nonnull align 8 dereferenceable(8) %17, float** nonnull align 8 dereferenceable(8) %13)
  call fastcc void @_ZL14setupMemoryGPUiiRPfS0_(i32 %101, float** nonnull align 8 dereferenceable(8) %18, float** nonnull align 8 dereferenceable(8) %14)
  %117 = bitcast float** %19 to i8**
  %118 = call i32 @hipMalloc(i8** nonnull %117, i64 %105)
  %119 = call i32 @hipGetLastError()
  %120 = icmp eq i32 %119, 0
  br i1 %120, label %125, label %121

121:                                              ; preds = %99
  %122 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %123 = call i8* @hipGetErrorString(i32 %119)
  %124 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %122, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.30, i64 0, i64 0), i32 300, i8* %123) #24
  call void @exit(i32 -1) #26
  unreachable

125:                                              ; preds = %99
  %126 = call i32 @hipDeviceSynchronize()
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 2)
  %127 = load float*, float** %17, align 8, !tbaa !9
  %128 = load float*, float** %18, align 8, !tbaa !9
  %129 = load float*, float** %19, align 8, !tbaa !9
  call void @_Z17computePhiMag_GPUiPfS_S_(i32 %101, float* %127, float* %128, float* %129)
  %130 = call i32 @hipDeviceSynchronize()
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 3)
  call fastcc void @_ZL16cleanupMemoryGPUiiRPfS_(i32 %101, float** nonnull align 8 dereferenceable(8) %19, float* %107)
  %131 = bitcast float** %17 to i8**
  %132 = load i8*, i8** %131, align 8, !tbaa !9
  %133 = call i32 @hipFree(i8* %132)
  %134 = bitcast float** %18 to i8**
  %135 = load i8*, i8** %134, align 8, !tbaa !9
  %136 = call i32 @hipFree(i8* %135)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %116) #22
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %115) #22
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %114) #22
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 6)
  %137 = call noalias align 16 i8* @calloc(i64 %104, i64 16) #22
  %138 = bitcast i8* %137 to %struct.kValues*
  ...
  %145 = icmp sgt i32 %101, 0
  %146 = bitcast float* %139 to i8*
  %147 = bitcast float* %141 to i8*
  %148 = bitcast float* %143 to i8*
  br i1 %145, label %149, label %256

149:                                              ; preds = %125
  %150 = zext i32 %101 to i64
  %151 = icmp ult i32 %101, 4
  br i1 %151, label %254, label %152

152:                                              ; preds = %149
  %153 = shl nuw nsw i64 %150, 4
  %154 = getelementptr i8, i8* %137, i64 %153
  %155 = getelementptr float, float* %139, i64 %150
  %156 = bitcast float* %155 to i8*
  %157 = getelementptr float, float* %141, i64 %150
  %158 = bitcast float* %157 to i8*
  %159 = getelementptr float, float* %143, i64 %150
  %160 = bitcast float* %159 to i8*
  %161 = shl nuw nsw i64 %150, 2
  %162 = getelementptr i8, i8* %106, i64 %161
  %163 = icmp ult i8* %137, %156
  %164 = icmp ugt i8* %154, %140
  %165 = and i1 %163, %164
  %166 = icmp ult i8* %137, %158
  %167 = icmp ugt i8* %154, %142
  %168 = and i1 %166, %167
  %169 = or i1 %165, %168
  %170 = icmp ult i8* %137, %160
  %171 = icmp ugt i8* %154, %144
  %172 = and i1 %170, %171
  %173 = or i1 %169, %172
  %174 = icmp ult i8* %137, %162
  %175 = icmp ult i8* %106, %154
  %176 = and i1 %174, %175
  %177 = or i1 %173, %176
  br i1 %177, label %254, label %178

178:                                              ; preds = %152
  %179 = and i64 %150, 4294967292
...
187:                                              ; preds = %187, %185
  ...
  %189 = phi i64 [ 0, %185 ], [ %228, %187 ]
  %190 = getelementptr inbounds float, float* %139, i64 %188
  %191 = bitcast float* %190 to <4 x float>*
  %192 = load <4 x float>, <4 x float>* %191, align 4, !tbaa !61, !alias.scope !74
  %193 = getelementptr inbounds float, float* %141, i64 %188
  %194 = bitcast float* %193 to <4 x float>*
  %195 = load <4 x float>, <4 x float>* %194, align 4, !tbaa !61, !alias.scope !77
  %196 = getelementptr inbounds float, float* %143, i64 %188
  %197 = bitcast float* %196 to <4 x float>*
  %198 = load <4 x float>, <4 x float>* %197, align 4, !tbaa !61, !alias.scope !79
  %199 = getelementptr inbounds float, float* %107, i64 %188
  %200 = bitcast float* %199 to <4 x float>*
  %201 = load <4 x float>, <4 x float>* %200, align 16, !tbaa !61, !alias.scope !81
  %202 = getelementptr inbounds %struct.kValues, %struct.kValues* %138, i64 %188, i32 3
  %203 = getelementptr inbounds float, float* %202, i64 -3
  %204 = bitcast float* %203 to <16 x float>*
  %205 = shufflevector <4 x float> %192, <4 x float> %195, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %206 = shufflevector <4 x float> %198, <4 x float> %201, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %207 = shufflevector <8 x float> %205, <8 x float> %206, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %207, <16 x float>* %204, align 16, !tbaa !61
  %208 = or i64 %188, 4
  %209 = getelementptr inbounds float, float* %139, i64 %208
  %210 = bitcast float* %209 to <4 x float>*
  %211 = load <4 x float>, <4 x float>* %210, align 4, !tbaa !61, !alias.scope !74
  %212 = getelementptr inbounds float, float* %141, i64 %208
  %213 = bitcast float* %212 to <4 x float>*
  %214 = load <4 x float>, <4 x float>* %213, align 4, !tbaa !61, !alias.scope !77
  %215 = getelementptr inbounds float, float* %143, i64 %208
  %216 = bitcast float* %215 to <4 x float>*
  %217 = load <4 x float>, <4 x float>* %216, align 4, !tbaa !61, !alias.scope !79
  %218 = getelementptr inbounds float, float* %107, i64 %208
  %219 = bitcast float* %218 to <4 x float>*
  %220 = load <4 x float>, <4 x float>* %219, align 16, !tbaa !61, !alias.scope !81
  %221 = getelementptr inbounds %struct.kValues, %struct.kValues* %138, i64 %208, i32 3
  %222 = getelementptr inbounds float, float* %221, i64 -3
  %223 = bitcast float* %222 to <16 x float>*
  %224 = shufflevector <4 x float> %211, <4 x float> %214, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %225 = shufflevector <4 x float> %217, <4 x float> %220, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %226 = shufflevector <8 x float> %224, <8 x float> %225, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %226, <16 x float>* %223, align 16, !tbaa !61
  %227 = add nuw i64 %188, 8
  %228 = add i64 %189, 2
  %229 = icmp eq i64 %228, %186
  br i1 %229, label %230, label %187, !llvm.loop !83

230:                                              ; preds = %187, %178
  %231 = phi i64 [ 0, %178 ], [ %227, %187 ]
  %232 = icmp eq i64 %183, 0
  br i1 %232, label %252, label %233

233:                                              ; preds = %230
  %234 = getelementptr inbounds float, float* %139, i64 %231
  %235 = bitcast float* %234 to <4 x float>*
  %236 = load <4 x float>, <4 x float>* %235, align 4, !tbaa !61, !alias.scope !74
  %237 = getelementptr inbounds float, float* %141, i64 %231
  %238 = bitcast float* %237 to <4 x float>*
  %239 = load <4 x float>, <4 x float>* %238, align 4, !tbaa !61, !alias.scope !77
  %240 = getelementptr inbounds float, float* %143, i64 %231
  %241 = bitcast float* %240 to <4 x float>*
  %242 = load <4 x float>, <4 x float>* %241, align 4, !tbaa !61, !alias.scope !79
  %243 = getelementptr inbounds float, float* %107, i64 %231
  %244 = bitcast float* %243 to <4 x float>*
  %245 = load <4 x float>, <4 x float>* %244, align 16, !tbaa !61, !alias.scope !81
  %246 = getelementptr inbounds %struct.kValues, %struct.kValues* %138, i64 %231, i32 3
  %247 = getelementptr inbounds float, float* %246, i64 -3
  %248 = bitcast float* %247 to <16 x float>*
  %249 = shufflevector <4 x float> %236, <4 x float> %239, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %250 = shufflevector <4 x float> %242, <4 x float> %245, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
  %251 = shufflevector <8 x float> %249, <8 x float> %250, <16 x i32> <i32 0, i32 4, i32 8, i32 12, i32 1, i32 5, i32 9, i32 13, i32 2, i32 6, i32 10, i32 14, i32 3, i32 7, i32 11, i32 15>
  store <16 x float> %251, <16 x float>* %248, align 16, !tbaa !61
  br label %252

252:                                              ; preds = %230, %233
  %253 = icmp eq i64 %179, %150
  br i1 %253, label %256, label %254

254:                                              ; preds = %152, %149, %252
  %255 = phi i64 [ 0, %152 ], [ 0, %149 ], [ %179, %252 ]
  br label %266

256:                                              ; preds = %266, %252, %125
  call void @free(i8* %106) #22
  %257 = bitcast float** %20 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %257) #22
  %258 = bitcast float** %21 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %258) #22
  %259 = bitcast float** %22 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %259) #22
  %260 = bitcast float** %23 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %260) #22
  %261 = bitcast float** %24 to i8*
  call void @llvm.lifetime.start.p0i8(i64 8, i8* nonnull %261) #22
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 3)
  call fastcc void @_ZL14setupMemoryGPUiiRPfS0_(i32 %102, float** nonnull align 8 dereferenceable(8) %20, float** nonnull align 8 dereferenceable(8) %10)
  call fastcc void @_ZL14setupMemoryGPUiiRPfS0_(i32 %102, float** nonnull align 8 dereferenceable(8) %21, float** nonnull align 8 dereferenceable(8) %11)
  call fastcc void @_ZL14setupMemoryGPUiiRPfS0_(i32 %102, float** nonnull align 8 dereferenceable(8) %22, float** nonnull align 8 dereferenceable(8) %12)
  %262 = bitcast float** %23 to i8**
  %263 = call i32 @hipMalloc(i8** nonnull %262, i64 %109)
  %264 = call i32 @hipGetLastError()
  %265 = icmp eq i32 %264, 0
  br i1 %265, label %286, label %282

266:                                              ; preds = %254, %266
  %267 = phi i64 [ %280, %266 ], [ %255, %254 ]
  %268 = getelementptr inbounds float, float* %139, i64 %267
  %269 = load float, float* %268, align 4, !tbaa !61
  %270 = getelementptr inbounds %struct.kValues, %struct.kValues* %138, i64 %267, i32 0
  store float %269, float* %270, align 16, !tbaa !84
  %271 = getelementptr inbounds float, float* %141, i64 %267
  %272 = load float, float* %271, align 4, !tbaa !61
  %273 = getelementptr inbounds %struct.kValues, %struct.kValues* %138, i64 %267, i32 1
  store float %272, float* %273, align 4, !tbaa !86
  %274 = getelementptr inbounds float, float* %143, i64 %267
  %275 = load float, float* %274, align 4, !tbaa !61
  %276 = getelementptr inbounds %struct.kValues, %struct.kValues* %138, i64 %267, i32 2
  store float %275, float* %276, align 8, !tbaa !87
  %277 = getelementptr inbounds float, float* %107, i64 %267
  %278 = load float, float* %277, align 4, !tbaa !61
  %279 = getelementptr inbounds %struct.kValues, %struct.kValues* %138, i64 %267, i32 3
  store float %278, float* %279, align 4, !tbaa !88
  %280 = add nuw nsw i64 %267, 1
  %281 = icmp eq i64 %280, %150
  br i1 %281, label %256, label %266, !llvm.loop !89

282:                                              ; preds = %256
  %283 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %284 = call i8* @hipGetErrorString(i32 %264)
  %285 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %283, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.30, i64 0, i64 0), i32 338, i8* %284) #24
  call void @exit(i32 -1) #26
  unreachable

286:                                              ; preds = %256
  %287 = load i8*, i8** %262, align 8, !tbaa !9
  %288 = call i32 @hipMemset(i8* %287, i32 0, i64 %109)
  %289 = bitcast float** %24 to i8**
  %290 = call i32 @hipMalloc(i8** nonnull %289, i64 %109)
  %291 = call i32 @hipGetLastError()
  %292 = icmp eq i32 %291, 0
  br i1 %292, label %297, label %293

293:                                              ; preds = %286
  %294 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %295 = call i8* @hipGetErrorString(i32 %291)
  %296 = call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %294, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.30, i64 0, i64 0), i32 341, i8* %295) #24
  call void @exit(i32 -1) #26
  unreachable

297:                                              ; preds = %286
  %298 = load i8*, i8** %289, align 8, !tbaa !9
  %299 = call i32 @hipMemset(i8* %298, i32 0, i64 %109)
  %300 = call i32 @hipDeviceSynchronize()
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 2)
  %301 = load float*, float** %20, align 8, !tbaa !9
  %302 = load float*, float** %21, align 8, !tbaa !9
  %303 = load float*, float** %22, align 8, !tbaa !9
  %304 = load float*, float** %23, align 8, !tbaa !9
  %305 = load float*, float** %24, align 8, !tbaa !9
  call void @_Z12computeQ_GPUiiPfS_S_P7kValuesS_S_(i32 %101, i32 %102, float* %301, float* %302, float* %303, %struct.kValues* %138, float* %304, float* %305)
  %306 = call i32 @hipDeviceSynchronize()
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 3)
  %307 = bitcast float** %20 to i8**
  %308 = load i8*, i8** %307, align 8, !tbaa !9
  %309 = call i32 @hipFree(i8* %308)
  %310 = bitcast float** %21 to i8**
  %311 = load i8*, i8** %310, align 8, !tbaa !9
  %312 = call i32 @hipFree(i8* %311)
  %313 = bitcast float** %22 to i8**
  %314 = load i8*, i8** %313, align 8, !tbaa !9
  %315 = call i32 @hipFree(i8* %314)
  call fastcc void @_ZL16cleanupMemoryGPUiiRPfS_(i32 %102, float** nonnull align 8 dereferenceable(8) %23, float* %111)
  call fastcc void @_ZL16cleanupMemoryGPUiiRPfS_(i32 %102, float** nonnull align 8 dereferenceable(8) %24, float* %113)
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %261) #22
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %260) #22
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %259) #22
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %258) #22
  call void @llvm.lifetime.end.p0i8(i64 8, i8* nonnull %257) #22
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 6)
  %316 = getelementptr inbounds %struct.pb_Parameters, %struct.pb_Parameters* %65, i64 0, i32 0
...
319:                                              ; preds = %297
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 1)
  call void @outputData(i8* nonnull %317, float* %111, float* %113, i32 %102)
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 6)
  br label %320

320:                                              ; preds = %297, %319
  call void @free(i8* %146) #22
  call void @free(i8* %147) #22
  call void @free(i8* %148) #22
  %321 = bitcast float** %10 to i8**
  %322 = load i8*, i8** %321, align 8, !tbaa !9
  call void @free(i8* %322) #22
  %323 = bitcast float** %11 to i8**
  %324 = load i8*, i8** %323, align 8, !tbaa !9
  call void @free(i8* %324) #22
  %325 = bitcast float** %12 to i8**
  %326 = load i8*, i8** %325, align 8, !tbaa !9
  call void @free(i8* %326) #22
  %327 = bitcast float** %13 to i8**
  %328 = load i8*, i8** %327, align 8, !tbaa !9
  call void @free(i8* %328) #22
  %329 = bitcast float** %14 to i8**
  %330 = load i8*, i8** %329, align 8, !tbaa !9
  call void @free(i8* %330) #22
  call void @free(i8* %137) #22
  call void @free(i8* %110) #22
  call void @free(i8* %112) #22
  call void @pb_SwitchToTimer(%struct.pb_TimerSet* nonnull %15, i32 0)
  call void @pb_PrintTimerSet(%struct.pb_TimerSet* nonnull %15)
  call void @free(i8* %317) #22
  %331 = load i8*, i8** %67, align 8, !tbaa !9
  %332 = icmp eq i8* %331, null
  br i1 %332, label %339, label %333

333:                                              ; preds = %320, %333
  %334 = phi i8* [ %337, %333 ], [ %331, %320 ]
  %335 = phi i8** [ %336, %333 ], [ %67, %320 ]
  call void @free(i8* nonnull %334) #22
  %336 = getelementptr inbounds i8*, i8** %335, i64 1
  %337 = load i8*, i8** %336, align 8, !tbaa !9
  %338 = icmp eq i8* %337, null
  br i1 %338, label %339, label %333, !llvm.loop !28

339:                                              ; preds = %333, %320
  %340 = bitcast i8** %67 to i8*
  call void @free(i8* %340) #22
  %341 = bitcast %struct.pb_Parameters* %65 to i8*
  call void @free(i8* %341) #22
  call void @llvm.lifetime.end.p0i8(i64 288, i8* nonnull %35) #22
...
; Function Attrs: mustprogress norecurse uwtable
define internal fastcc void @_ZL14setupMemoryGPUiiRPfS0_(i32 %0, float** nonnull align 8 dereferenceable(8) %1, float** nocapture nonnull readonly align 8 dereferenceable(8) %2) unnamed_addr #19 {
  %4 = bitcast float** %1 to i8**
  %5 = shl nsw i32 %0, 2
  %6 = sext i32 %5 to i64
  %7 = tail call i32 @hipMalloc(i8** nonnull %4, i64 %6)
  %8 = tail call i32 @hipGetLastError()
  %9 = icmp eq i32 %8, 0
  br i1 %9, label %14, label %10

10:                                               ; preds = %3
  %11 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %12 = tail call i8* @hipGetErrorString(i32 %8)
  %13 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %11, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.30, i64 0, i64 0), i32 217, i8* %12) #24
  tail call void @exit(i32 -1) #26
  unreachable
...
14:                                               ; preds = %3
  ...
  %18 = tail call i32 @hipMemcpy(i8* %15, i8* %17, i64 %6, i32 1)
  %19 = tail call i32 @hipGetLastError()
  %20 = icmp eq i32 %19, 0
  br i1 %20, label %25, label %21

21:                                               ; preds = %14
  %22 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %23 = tail call i8* @hipGetErrorString(i32 %19)
  %24 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %22, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.30, i64 0, i64 0), i32 219, i8* %23) #24
  tail call void @exit(i32 -1) #26
  unreachable
...
; Function Attrs: mustprogress norecurse uwtable
define internal fastcc void @_ZL16cleanupMemoryGPUiiRPfS_(i32 %0, float** nocapture nonnull readonly align 8 dereferenceable(8) %1, float* %2) unnamed_addr #19 {
  %4 = bitcast float* %2 to i8*
  %5 = bitcast float** %1 to i8**
  %6 = load i8*, i8** %5, align 8, !tbaa !9
  %7 = shl nsw i32 %0, 2
  %8 = sext i32 %7 to i64
  %9 = tail call i32 @hipMemcpy(i8* %4, i8* %6, i64 %8, i32 2)
...
12:                                               ; preds = %3
  ...
  %15 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %13, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.30, i64 0, i64 0), i32 226, i8* %14) #24
  tail call void @exit(i32 -1) #26
  unreachable

16:                                               ; preds = %3
  %17 = load i8*, i8** %5, align 8, !tbaa !9
...
21:                                               ; preds = %16
  %22 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !9
  %23 = tail call i8* @hipGetErrorString(i32 %19)
  %24 = tail call i32 (%struct._IO_FILE*, i8*, ...) @fprintf(%struct._IO_FILE* %22, i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.30, i64 0, i64 0), i32 228, i8* %23) #24
  tail call void @exit(i32 -1) #26
  unreachable
...
6:                                                ; preds = %4, %1
  %7 = phi i8** [ %5, %4 ], [ %2, %1 ]
  %8 = tail call i32 @__hipRegisterFunction(i8** %7, i8* bitcast (void (float*, float*, float*, i32)** @_Z17ComputePhiMag_GPUPfS_S_i to i8*), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @0, i64 0, i64 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @0, i64 0, i64 0), i32 -1, i8* null, i8* null, i8* null, i8* null, i32* null)
  %9 = tail call i32 @__hipRegisterFunction(i8** %7, i8* bitcast (void (i32, i32, float*, float*, float*, float*, float*)** @_Z12ComputeQ_GPUiiPfS_S_S_S_ to i8*), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @1, i64 0, i64 0), i8* getelementptr inbounds ([29 x i8], [29 x i8]* @1, i64 0, i64 0), i32 -1, i8* null, i8* null, i8* null, i8* null, i32* null)
  tail call void @__hipRegisterVar(i8** %7, i8* bitcast ([1024 x %struct.kValues]* @ck to i8*), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @2, i64 0, i64 0), i8* getelementptr inbounds ([3 x i8], [3 x i8]* @2, i64 0, i64 0), i32 0, i64 16384, i32 1, i32 0)
...
attributes #18 = { mustprogress nofree nounwind uwtable willreturn "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
attributes #19 = { mustprogress norecurse uwtable "frame-pointer"="none" "min-legal-vector-width"="0" "no-trapping-math"="true" "stack-protector-buffer-size"="8" "target-cpu"="x86-64" "target-features"="+cx8,+fxsr,+mmx,+sse,+sse2,+x87" "tune-cpu"="generic" }
...
!84 = !{!85, !62, i64 0}
!85 = !{!"_ZTS7kValues", !62, i64 0, !62, i64 4, !62, i64 8, !62, i64 12}
!86 = !{!85, !62, i64 4}
!87 = !{!85, !62, i64 8}
!88 = !{!85, !62, i64 12}
