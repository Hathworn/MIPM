...
static const char *kernel1_cache = "fdtd_step1_kernel_cache"; // 核函数名称
static const char *kernel2_cache = "fdtd_step2_kernel_cache"; // 核函数名称
static const char *kernel3_cache = "fdtd_step3_kernel_cache"; // 核函数名称
