 ...
 */
 ...
 static const char *devProgram = "./3DConvolution.dev.dat"; // 设备端二进制文件的位置
 static const char *kernel = "convolution3D_kernel";        // 核函数名称
 static const char *kernel_cache = "convolution3D_kernel_cache";        // 核函数名称
