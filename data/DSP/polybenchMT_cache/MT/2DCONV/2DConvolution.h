...
#define DIM_THREAD_BLOCK_Y 8
 ...
 static const char *devProgram = "./2DConvolution.dev.dat"; // 设备端二进制文件的位置
 static const char *kernel = "convolution2D_kernel";        // 核函数名称
 static const char *kernel_cache = "convolution2D_kernel_cache";        // 核函数名称
